    ...
    <nav class="container flex flex-col sm:flex-row items-center gap-4 text-white py-6">
      <RouterLink :to="{ name: 'home' }">
        <div class="flex items-center gap-3">
          ...
          <p class="text-2xl">Sweather Weather</p>
        </div>
      </RouterLink>

      <div class="flex gap-3 flex-1 justify-end">
        <i
          class="fa-solid fa-circle-info fa-lg hover:text-weather-secondary duration-150 cursor-pointer"
          @click="toggleModal"
        ></i
        ><i
          class="fa-solid fa-plus fa-lg hover:text-weather-secondary duration-150 cursor-pointer"
          @click="addCity"
      ...
      <BaseModal :modalActive="modalActive" @close-modal="toggleModal">
        <div class="text-black">
          ...
          <p class="mb-4">
            The Sweather Weather app allows you to track the current and future weather of cities of
            your choosing.
          </p>
          ...
          <p>
            ...
            the bottom of the page, there will be an option to delete the city.
          </p>
        </div>
      </BaseModal>
    </nav>
